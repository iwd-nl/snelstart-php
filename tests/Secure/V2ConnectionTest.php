...
/**
 * Actually a copy of version 1...
 *
 * @todo Write more tests evidently...
 */
class V2ConnectionTest extends TestCase
{
    /**
     * @var V1Connector|MockObject
     */
    ...
    public function setUp()
    {
        ...
        $this->connection = $this->getMockBuilder(V2Connector::class)
